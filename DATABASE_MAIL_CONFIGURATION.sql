...
-- Account and SQL Operator information. Replace with the information for your account.
	SET @account_name = 'any name';
	SET @SMTP_servername = 'mail server';
	SET @email_address = 'email for sending the alerts';
    SET @display_name = 'display name for the email';
	SET @port_number = 'port number';
	SET @desc_p = 'Mail account used by DBA staff';
	SET @desc_a = 'Mail account used by DBA staff';
	SET @customoper = 'operator username/group'
...
-----------------**************************************************************************-----------------
-- Run below SP to change any info of mail account. Replace XXXX & XX with your correct SMTP IP address 
-- and port no.
-- TO CHANGE ANY CONFIGS ON THE DATABASE MAIL ACCOUNT
-----------------**************************************************************************-----------------

EXECUTE msdb.dbo.sysmail_update_account_sp
    @account_name = 'any name'
    ,@description = 'Mail account used by DBA staff'
    ,@mailserver_name = 'server name'
    ,@mailserver_type = 'protocol'
    ,@port = 'port number'
